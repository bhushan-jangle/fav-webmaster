      ...
      <div class="row-fluid">
        ...
        <div class="span6">
          <ul class="breadcrumb pull-right">
            ...
            <li><a href="registration.php">Registration</a> <span class="divider">/</span></li>
            <li class="active"></li>
          </ul>
        </div>
      </div>
    ...
    <form class="center" action='' method="POST">
      <fieldset class="registration-form">
        <div class="control-group">
          <!-- Username -->
          <div class="controls">
           <input type="text"id="username" name="user"placeholder="Email" class="input-xlarge"><br />  
          </div>
        </div>
        ...
        <div class="control-group">
          <!-- Password-->
          <div class="controls">
          <input type="password" id="password" name="pass"placeholder="Password" class="input-xlarge"><br />   
          </div>
        </div>
...
if(!empty($_POST['user']) && !empty($_POST['pass'])) {  
    ...
    mysqli_select_db($con,'my_registration') or die("cannot select DB");  
