      ...
      <div class="row-fluid">
        ...
        <div class="span6">
          <ul class="breadcrumb pull-right">
						...
						<li><a href="types.php">Types Of Webs</a> <span class="divider">/</span></li>
                       
						 
						  <li><a href="addweb.php">Add Webs</a> <span class="divider">/</span></li>
						 <li><a href="added.php">Added Webs</a> <span class="divider">/</span></li>
						 
						 <li ><a href="favourite.php" >Favourite Webs</a><span class="divider">/</span></li>
						 <li><a href="alladdfav.php">Collection</a> <span class="divider">/</span></li>
    ...
    <form class="center" action='' method="POST">
      <fieldset class="registration-form">
        <div class="control-group">
          <!-- Username -->
          <div class="controls">
          <input type="text" id="username" name="weburl" placeholder="weburl" class="input-xlarge"><br />  
          </div>
        </div>
        ...
        <div class="control-group">
          <!-- Password-->
          <div class="controls">
           <input type="text" id="password" name="webtitle" placeholder="webtitle" class="input-xlarge"><br />   
          </div>
        </div>
        ...
        <div class="control-group">
          <!-- Button -->
          <div class="controls">
            <input type="submit" value="Add Website" name="submit" /> 
          </div>
        </div>
      </fieldset>
    </form>
...
mysqli_query($con,"INSERT INTO addweb(Weburl,Webtitle)
		        VALUES ('$weburl','$webtitle')");

if(mysqli_affected_rows($con) > 0){
	echo "<p>Your Website Added In Your Web Collection</p>";
