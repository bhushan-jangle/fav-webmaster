      ...
      <div class="row-fluid">
        ...
        <div class="span6">
          <ul class="breadcrumb pull-right">
            ...
            <li><a href="login1.php">Login</a> <span class="divider">/</span></li>
            <li class="active"></li>
          </ul>
        </div>
      </div>
    ...
    <form class="center" action='' method="POST">
      <fieldset class="registration-form">
        <div class="control-group">
          <!-- Username -->
          <div class="controls">
          <input type="text" id="username" name="user" placeholder="weburl" class="input-xlarge"><br />  
          </div>
        </div>
        ...
        <div class="control-group">
          <!-- Password-->
          <div class="controls">
           <input type="text" id="password" name="pass" placeholder="webtitle" class="input-xlarge"><br />   
          </div>
        </div>
...
if(!empty($_POST['weburl']) && !empty($_POST['webtitle'])) {  
    ...
    mysqli_select_db($con,'mywebmasterf') or die("cannot select DB");  
  
    $query=mysqli_query($con,"SELECT * FROM addweb WHERE weburl='".$user."'");  
    $numrows=mysqli_num_rows($query);  
    if($numrows==0) 
    {  
    $sql="INSERT INTO addweb(username,password) VALUES('$user','$pass')";  
    ...
    echo "That Website already exists! Please try again with another.";  
    }  
