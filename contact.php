        ...
        <div class="row-fluid">
                ...
                <form  method="post" action="">
                  <div class="row-fluid">
                    <div class="span5">
						...
						<input type="text" id="fname" class="input-block-level" required="required" name="fname" placeholder="Your First Name">
                        <label>Last Name</label>
                        <input type="text" class="input-block-level" required="required" name="lname" placeholder="Your Last Name">
                        <label>Email Address</label>
                        <input type="text" id="fname" class="input-block-level" required="required" name="email" placeholder="Your email address">
                    </div>
                    <div class="span7">
                        <label>Message</label>
                        <textarea name="message" id="message"  name="message" required="required" class="input-block-level" rows="8"></textarea>
                    </div>
          ...
          <div class="controls">
			...
			<?php
				...
				mysqli_query($con,"INSERT INTO contact(fname,lname,email,message)
								VALUES ('$fname','$lname','$email','$message')");

				if(mysqli_affected_rows($con) > 0){
					echo "<p>Thanks For Contact With Us.</p>";
					
				} else {
					echo "Your Message Not Send.<br />";
